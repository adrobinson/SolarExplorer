...
This is the readme for SolarExplorer, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. SolarExplorer) > Ok.
...
- To run the project find SolarExplorer.java (which will be in under src/main/java/solarexplorer) and right click > Run 'SolarExplorer'
